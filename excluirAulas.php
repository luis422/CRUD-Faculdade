...
<body class="bg-secondary">
    <div class="container bg-white rounded mt-4 mb-4 pt-2 pb-2 panel">
        <p class="h3 mt-4 text-center fw-bold text-title user-select-none">Excluir Aula</p>
        ...
        <div class="container mt-4 mb-4 d-flex justify-content-center">
            <div class="col col-12 col-sm-6">
                ...
                <div class="d-flex justify-content-center">
                    <form action="backend/excluirAula.php" method="POST">
                        
                        <div class="form-check">
                            <input class="red-accent rounded form-check-input" onchange="refreshColor('confirm','bc404282-8d4f-43f7-bc12-02f97785eba1')" type="checkbox" id="confirm" autofocus required>
                            <label class="form-check-label" for="confirm">
                                <span class="fw-bolder user-select-none">Estou ciente de que esta é uma ação irreversível, e todas as <span class="text-uppercase text-danger">presenças</span> desta aula serão <span class="text-uppercase text-danger">permanentemente excluídas</span>.</span>
                            </label>
                        </div>
                        <div class="input-group mb-3 w-100">
                            <input required type="text" value="<?=$value?>" class="red-accent form-control" placeholder="Digite o ID" name="ID">
