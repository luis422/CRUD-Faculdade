...
if($_GET["CPF"]!=NULL or $_GET["CPF"]!=""){
    $value=$_GET["CPF"];
}else{
    header("location:editarAlunoCpf.php");
}
...
<body class="bg-secondary">
    <div class="container bg-white rounded mt-4 mb-4 pt-2 pb-3 panel">
        <p class="h3 mt-4 text-center fw-bold text-title user-select-none">Editar Aluno</p>
        ...
        <div class="container-sm mt-4 mb-4">
            <div class="col col-11 offset-1">
                ...
                <?php
                    ...
                    try{
                        $cpf=$_GET["CPF"];
                        $seleciona=mysqli_query($conexao, "SELECT * FROM aluno WHERE CPF='$cpf'");
                ...
                <form action="backend/updateAluno.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col col-12 col-sm-9 col-lg-8">
                            <div class="row">
                                ...
                                <div class="col col-12 col-sm-12 col-lg-5">
                                    ...
                                    <input class="btn-outline-green form-control w-100" type="text" value="<?=$campo["TELEFONE_RESPONSAVEL"]?>" name="TELEFONE_RESPONSAVEL" id="TELEFONE_RESPONSAVEL" maxlength="17" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col col-12 col-lg-12">
                                    ...
                                    <input class="btn-outline-green form-control" rols="3" class="w-100" type="text" value="<?=$campo["NOME_RESPONSAVEL"]?>" name="NOME_RESPONSAVEL" id="NOME_RESPONSAVEL" maxlength="250" required>
                                </div>
                            </div>
                        </div>
                    </div>
