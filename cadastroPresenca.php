...
<head>
    ...
    <title>Cadastrar Presença</title>
...
<body class="bg-secondary">
    <div class="container bg-white rounded mt-4 mb-4 pt-2 pb-3 panel">
        <p class="h3 mt-4 text-center fw-bold text-title user-select-none">Cadastrar Presença</p>
        <div class="w100 border mt-4"></div>
        <div class="container-sm mt-4 mb-4">
            <div class="col col-11 offset-1">
                <form action="backend/gravaPresenca.php" method="POST">
                    <div class="row">
                        ...
                        <div class="row">
                                <div class="col col-12 col-lg-12">
                                    ...
                                    <select class="form-select form-select-md btn-outline-green" id="ID_AULA" name="ID_AULA" required>
                                        <?php
                                            ...
                                            $seleciona=mysqli_query($conexao, "SELECT ID,TITULO,aula.DATA_AULA FROM aula ORDER BY DATA_AULA DESC");
                                            $nada=0;
                                            while($aula=mysqli_fetch_array($seleciona)){
                                                $nada=1;
                                                ?>
                                                    <option name="opcAula" value="<?=$aula["ID"]?>"><?=$aula["DATA_AULA"]," - ",$aula["TITULO"]?></option>
                                                <?php
                                            }
                                            if($nada==0){?>
                            ...
                            <div class="form-check m-1 mt-4">
                                <input class="form-check-input" onchange="refreshPresenca()" type="checkbox" checked name="PRESENTE" id="PRESENTE">
