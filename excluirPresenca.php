...
<body class="bg-secondary">
    <div class="container bg-white rounded mt-4 mb-4 pt-2 pb-2 panel">
        <p class="h3 mt-4 text-center fw-bold text-title user-select-none">Excluir Presença</p>
        ...
        <div class="container mt-4 mb-4 d-flex justify-content-center">
            <div class="col col-12 col-sm-6">
                ...
                <div class="d-flex justify-content-center">
                    <form action="backend/excluirPresencaID.php" method="POST">
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="confirm">
                                <span class="fw-bolder user-select-none">Estou ciente de que esta é uma ação irreversível</span>
                            </label>
                        </div>
