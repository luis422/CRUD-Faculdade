...
<body class="bg-secondary">
    <div class="container bg-white rounded mt-4 mb-4 pt-2 pb-3 panel">
        <p class="h3 mt-4 text-center fw-bold text-title user-select-none">Cadastrar Aula</p>
        <div class="w100 border mt-4"></div>
        <div class="container-sm mt-4 mb-4">
            <div class="col col-11 offset-1">
                <form action="backend/gravaAula.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col col-12 col-sm-9 col-lg-8">
                            <div class="row">
                                <div class="col col-12">
                                    ...
                                    <input class="btn-outline-green form-control w-100" type="text" name="TITULO" id="TITULO" maxlength="30" required autofocus>
                                </div>
                                <div class="col col-6">
                                    <label class="mt-3 user-select-none" for="DATA_AULA"><span class="text-danger fw-bold">*</span>Data da Aula</label><br>
                                    <input class="btn-outline-green form-control" rols="3" class="w-100" type="date" name="DATA_AULA" id="DATA_AULA" required>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col col-12 col-lg-12">
                                    ...
                                    <textarea class="btn-outline-green form-control w-100" rows="8" type="text" name="DESCRICAO" id="DESCRICAO" maxlength="300" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
